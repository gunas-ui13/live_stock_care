...
<head>
    ...
    <title>Vetcare - Admin Sign Up</title>
    <style>
        /* Basic Reset */
        * {
            margin: 0;
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="admin_connect.php" method="post">
                ...
                <input type="text" id="contact" name="contact" placeholder="Enter your contact number" maxlength="10" required>
                ...
                <!-- Submit Button -->
                <button type="submit" name="submit">Create Admin Account</button>
